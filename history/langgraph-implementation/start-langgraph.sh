...
#
# Usage:
#   ./start-langgraph.sh          # Start all servers (2024 + 8123 + 3000) [DEFAULT]
#   ./start-langgraph.sh --studio # Start LangGraph Studio only (2024)
#   ./start-langgraph.sh --web    # Start web app only (8123 + 3000)
#   ./start-langgraph.sh --all    # Start all servers (2024 + 8123 + 3000)
#
# To stop the application, use: ./stop-langgraph.sh
# =============================================================================
